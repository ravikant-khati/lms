...
import { createCourse, editCourse, getAllCoursesForAdmin } from '../controllers/course.controller.js'
...
courseRouter.put("/edit/:courseID" , isAuthenticate,upload.single("courseThumbnail") , editCourse)
